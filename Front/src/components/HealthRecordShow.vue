<template>
  <div class="page-wrap">
    <!-- 顶部栏 -->
    <div class="toolbar">
      <div class="title">数据管理（Data Table）</div>
      <div class="ops">
...
export default {
  ...
  setup() {
    ...
    return {
      // state
      loading, saving, list, keyword,
      viewVisible, viewData,
      formVisible, isEdit, formRef, form, rules,
      // computed
      filteredList,
      // methods
      fetchList, openView, openCreate, openEdit, submitForm, deleteRow
    }
  }
}
</script>
